...
export default function Header() {
  return (
    <div>
      <div className="bg-[url('./assets/images/hero-bg.jpg')] bg-bottom h-[100dvh] lg:h-[150dvh] bg-cover bg-no-repeat">
        <div className="bg-[rgba(0,0,0,0.5)] h-full">
          ...
          <div className="ml-[20px] mt-[100px] flex justify-between md:ml-[50px] md:mt-[150px] lg:ml-[100px] lg:mt-[200px]">
            <motion.div
            ...
            >
              ...
              <h1 className="text-[white] text-[30px] font-bold mt-[10px] w-[300px] leading-relaxed md:text-[40px] md:w-[450px] lg:text-[55px] lg:w-[600px]">
